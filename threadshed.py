...
transactions_clean = [j.strip() for i in daily_transactions_split for j in i]
...
for i in thread_sold:
    if "&" in i:
        thread_split.append(i.split("&"))
    else:
        thread_sold_split.append(i)
for i in thread_split:
    for j in i:
...
for i in colors:
    print(f"{color_count(i)} {i} threads were sold today.")
